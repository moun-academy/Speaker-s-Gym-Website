...
/* Brand-matched Calendly embed (colours without #, per Calendly's API) */
const CALENDLY_URL =
  `${CALENDLY_SLUG}` +
  "?hide_gdpr_banner=1" +
  "&background_color=111111" +
  "&text_color=e0ddd4" +
  "&primary_color=d9c06f";
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .bc-widget-wrap { margin:36px auto 0; border:1px solid var(--border); border-radius:16px; overflow:hidden; background:var(--bg2); box-shadow:0 20px 60px rgba(0,0,0,.35); }
        .bc-widget { min-width:320px; width:100%; height:760px; }
        .bc-widget-loading { display:flex; flex-direction:column; align-items:center; justify-content:center; height:760px; gap:18px; color:var(--text-dim); }
        .bc-spinner { width:34px; height:34px; border:3px solid var(--border); border-top-color:var(--accent); border-radius:50%; animation:bc-spin .8s linear infinite; }
