...
export default function KhadijaPortal() {
  useEffect(() => {
    ...
    document.title = "Khadija's Speaking Journey | Speaker's Gym";
  ...
  return (
    <main className="khadija-portal-shell">
      <iframe
        ...
        src="/khadija-portal/index.html"
        title="Khadija's private Speaker's Gym coaching portal"
      />
    </main>
  );
}
